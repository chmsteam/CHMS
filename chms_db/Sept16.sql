...
CREATE TABLE `tblcontract` (
  ...
  `intConSalary` int(11) DEFAULT NULL,
...
INSERT INTO `tblfee` VALUES (1,'Agency Fee',8000.00,'Active'),(2,'Drop-off',600.00,'Active'),(3,'Pick-up',0.00,'Active'),(4,'Replacement Fee',1000.00,'Active');
...
INSERT INTO `tblmcity` VALUES (1,'Caloocan','Active'),(2,'Makati','Active');
...
INSERT INTO `tblmincidentreport` VALUES (1,'Personal Injury','Physical injury inflicted on a person\'s body.','Low','Active'),(2,'sample',';\'djasdsadasdasd',NULL,'Active');
...
INSERT INTO `tblmleave` VALUES (1,'Vacation Leave',5,7,'Active'),(2,'Sick Leave',1,1,'Active');
...
INSERT INTO `tblmrequirements` VALUES (1,'NBI','Client','Active'),(2,'2 Valid ID','Client','Active');
...
INSERT INTO `tblmskills` VALUES (1,'Can international course',NULL,'Active'),(2,'Knows how to iron clothes',1,'Active');
...
CREATE TABLE `tblreport` (
  ...
  `strEviPic` varchar(45) DEFAULT NULL,
...
INSERT INTO `tblreport` VALUES (1,1,6,1,'','','2018-09-16','2018-09-16-6-1-c6HSNxu7CJ.jpg','','');
